...
public class MarqueeView extends LinearLayout {
     ...
     */
    private static final int DEFAULT_ANIMATION_PAUSE = 2500;
    ...
    private static final int END_WIDTH = 100;
    ...
    private void extractAttributes(AttributeSet attrs) {
        ...
        mAutoStart = a.getBoolean(R.styleable.asia_ivity_android_marqueeview_MarqueeView_autoStart, true);
...
//            float textWidth = mPaint.measureText(tv.getText().toString());
//            if (textWidth>getResources().getDisplayMetrics().widthPixels) {
                initView(getContext());
                prepareAnimation();
...
//            }
    ...
    private void prepareAnimation() {
        ...
        mTextWidth = mPaint.measureText(mTextField.getText().toString()) + END_WIDTH;
...
//                mTextField.startAnimation(mMoveTextIn);
    ...
    private void initView(Context context) {
        ...
        mScrollView.addView(mTextField, new ScrollView.LayoutParams((int) mTextWidth, LayoutParams.WRAP_CONTENT));
