...
public class MyRecyclerView extends RecyclerView implements OnScrollListener {
    ...
    public ListViewFooter getmFooterView() {
        return mFooterView;
    }

    public void setmFooterView(ListViewFooter mFooterView) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mLastY = ev.getRawY();
//                if (findViewHolderForLayoutPosition(getChildCount()) == mTotalItemCount - 1 && (mFooterView.getBottomMargin() > 0 || deltaY < 0)) {
