...
public class BuySellListRequest {
    ...
    public BuySellListRequest(Activity activity,HashMap<String, String> map) {
    ...
    public void http(final boolean flag) {
        ...
        String url = Global.SERVER_URL + "ph/"+map.get("actName");
        OkHttpUtils
                .post()
                .url(url)
                .params(map)
    ...
    public void setRefresh() {
        ...
        ptrFrameLayout = (PtrClassicFrameLayout) activity.findViewById(R.id.fragment_PtrLayout);
        //下拉刷新
