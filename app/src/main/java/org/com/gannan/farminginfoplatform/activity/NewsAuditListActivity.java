...
public class NewsAuditListActivity extends AppCompatActivity implements BuySellListRequest.RefreshComplete {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTv.setText(getString(R.string.str_msg103));
        initList();
    }
    public void initList() {
        ...
        adapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                Intent intent = new Intent(NewsAuditListActivity.this, AuditDetailActivity.class);
                ...
                AnimUtil.changePageIn(NewsAuditListActivity.this);
            }
