...
public class ListViewFooter extends LinearLayout {
	...
	public void setState(int state) {
		...
		if (state == STATE_READY) {
			...
			mHintView.setText(R.string.load_more_footer_hint_ready);
		} else if (state == STATE_LOADING) {
			mProgressBar.setVisibility(View.VISIBLE);
		} else {
			mHintView.setVisibility(View.GONE);
			mHintView.setText(R.string.load_more_footer_hint);
		}
	}
	...
	private void initView(Context context) {
		...
		mProgressBar = moreView.findViewById(R.id.recyclerview_footer_progressbar);
