            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        ...
                        map.put("token", SharedUtil.getToken(PublishDetailActivity.this));
                         map.put("state","4");
                        new AudioRequest(PublishDetailActivity.this,map,4);
                        break;
                    case 1:
                        showNoticeDialog();
                        break;
                    case 2:
                        Intent intent = new Intent(PublishDetailActivity.this, ModifyDetailActivity.class);
                        intent.putExtra("id",getIntent().getStringExtra("id"));
                        intent.putExtra("requestCode",104);
                        startActivityForResult(intent,104);
                        AnimUtil.changePageIn(PublishDetailActivity.this);
                        break;
                }
                dialog.dismiss();
            }
    ...
    public void showNoticeDialog() {
        ...
        okBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                map.put("state","5");
                new AudioRequest(PublishDetailActivity.this,map,5);
                dialog.dismiss();
            }
        });
